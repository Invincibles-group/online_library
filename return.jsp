...
<div id="page">
	...
	<div id="content">
		<div class="post">
	<center> <h1 class="title">Return-of-Books</h1></center>
    
    
				
                <center>
            <form id="send" action="returnsave.jsp">
                ...
                <tr>
               <td> <label for="company">Book Name</label></td>
               <td> <input id="company" type="text" name="bname" value="" required /></td>
                
                </tr>
                 <tr>

                <td><label for="email">Book Code</label></td>
                <td><input id="email" type="text" name="bcode" value="" required/></td>
                </tr>
                
                <tr>

                <td><label for="email">Date of Issue</label></td>
              <td>  <input id="email" type="password" name="doi" value="" required/></td>
                </tr>
