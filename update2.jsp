...
<%@ include file="db.jsp"%>
	<div class="article">
	  ...
	  <form name='f' action="update3.jsp" method="POST">
		   <table border="0.5" cellspacing="4" cellpadding="3">
	  	<tr>
	  		<td><B> Select Book</td>
	  		<td>		

		<select name="book" onchange="f.submit();">
		<%
		...
		while(rs.next())
		{
			if(book.equals(rs.getString("bcode")))
			{
		...
		<tr>
			<td>Book Name</td>
			<td> <input type="text" name="bname" size="30" value="<%=bname%>"><br></td></tr>
			<tr>
		<td>Author </td> <td><input type="text" name="author" size="30" value="<%=author%>"><br></td></tr>
		<tr><td>
