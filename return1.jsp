...
<%@ include file="db.jsp"%>
	<div class="article">
	  ...
	  <form name='f' action="return2.jsp" method="POST">
	   <table border="0.5" cellspacing="4" cellpadding="3">
		...
		<br>
		<tr><td>
		Member Id:</td><td> <input type="text" name="mname" size="30"><br></td></tr>
		<tr>
		<td>
		Book Name:	</td><td><input type="text" name="bname" size="30"><br></td></tr>
		<tr>
		<td>
		Date of Issue: </td><td><input type="text" name="doi" size="30"><br></td></tr>
		<tr>
		<td>
		Date of Expiry:</td><td> <input type="text" name="doe" size="30"><br></td></tr>
	<tr>
	<td>
		<input class="submit" type="Submit" value="Return"></td></tr>
	  </form>
	  </table>
