...
<div id="page">
	...
	<div id="content">
		<div class="post">
			...
			<center> <h1 class="title">Stock-Maintainance</h1></center>
    
				
                <center>
            <form id="send" action="stocksave.jsp">
					<table border="0.5" cellspacing="4" cellpadding="3">
				<tr>
					<td><label for="name">Book Name *</label></td>
					<td><input id="name" type="text" name="bname" value="" required /></td>
               ...
               <td> <input id="company" type="text" name="bcode" value="" required /></td>
                ...
                <td><label for="email">Author</label></td>
                <td><input id="email" type="text" name="author" value="" required/></td>
                </tr>
