...
<link href="style21.css" rel="stylesheet" type="text/css/styles" media="screen" />
</head>
<body>
<div id="main">
<!-- start header -->
...
<div id="menu">
   ...
   <li><a href="issue.jsp">Issue Of Books</a></li>
...
<div id="page">
	...
	<div id="content">
		<div class="post">
	<center> <h1 class="title">Issue Of Books</h1></center>
    
				
                <center>
            <form id="send" action="issuesave1.jsp">
               ...
               <td> <label for="company">Book Code</label></td>
               <td> <input id="company" type="text" name="bcode" value="" required /></td>
                
                </tr>
                 <tr>

                <td><label for="email">Book Name</label></td>
                <td><input id="email" type="text" name="bname" value="" required/></td>
                </tr>
                
                <tr>

                <td><label for="email">Date of Issue</label></td>
              <td>  <input id="email" type="text" name="doi" value="" required/></td>
                </tr>
                
                <tr>
               <td> <label for="website">Date Of Expiry</label></td>
                <td><input id="website" type="text" name="doe" value="" required/></td>
                </tr>
               
                
                <tr>

                <td>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="submit" type="submit" >Submit</button><button id="submit" type="reset" >Reset</button></td>  
